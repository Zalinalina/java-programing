...
A number is an Armstrong number if the single digits of the number raised to the power of the number of digits is equal
 to the original number
    ...
    public static boolean isArmstrong (int num) {
        ...
        for (int i =0; i < strNum.length(); i++){
            ...
            sum += Math.pow(eachDigit, power);// 1 ^ 3 = 1*1*1  // 5^3= 5*5*5
