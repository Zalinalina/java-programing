...
public class UpdaitingArrayList {
    public static void main(String[] args) {
        ...
        String allCarsIn1St = myCars.toString();//saves all cars in one string
        ...
        myCars.set(4, "honda");
        System.out.println("After set honda = " + myCars);//.toString());//to string optional
        ...
        //find the indexOf number of "ford"
        //  String str = "java";
        // str.indexOf("v") ==>2
